...
export function PortfolioEditor({ sectionId, content }: Props) {
  ...
  return (
    <div className="space-y-6">
      <div className="rounded-lg border border-gray-200 bg-white p-6 space-y-5">
        <h2 className="font-semibold text-gray-800">Portfolio Section</h2>
        <p className="text-sm text-gray-500">
          Individual portfolio items are managed in{" "}
          <a href="/admin/portfolio" className="text-blue-600 underline">Portfolio</a>.
        </p>
